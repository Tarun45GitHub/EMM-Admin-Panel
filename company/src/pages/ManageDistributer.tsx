    ...
    return (
       <div className="w-full min-h-screen bg-white dark:bg-[#0F172A] p-4 md:p-8 space-y-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
                <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Distributor</h1>
                <p className="text-gray-500 dark:text-gray-400">Manage your Distributor Team</p>
            </div>
            <AddEntrybutton value={"Add user"} />
        </div>
