...
const Reclaim: React.FC = () => {
  ...
  return (
    <div className=" bg-gray-100 dark:bg-gray-600 flex items-center justify-center p-6">
      <form
        onSubmit={handleSubmit}
        className="bg-white dark:bg-gray-800 shadow-lg rounded-lg max-w-md w-full p-8 space-y-6"
      >
        ...
        <div>
          <label className="block text-gray-700 dark:text-gray-200 font-medium mb-1">
            Select User to Reclaim Money
          </label>
          <select
            value={recipient}
            onChange={handleRecipientChange}
            className="w-full border dark:text-gray-200 border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-indigo-400"
            required
          >
