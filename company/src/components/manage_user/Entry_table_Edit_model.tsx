...
const EntryTableEditModel: React.FC = () => {
       ...
       border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div className="w-70 sm:w-130 md:w-150 lg:w-230 xl:w-300 overflow-x-auto scrollbar-custom">
          <table className=" w-full table-auto text-sm border-collapse">
            <thead className="bg-gray-500   dark:text-gray-200 ">
              <tr>
                {[
            ...
            <tbody>
              {pageRows.map((row, idx) => (
                <tr
                  ...
                  className={`${
                    idx % 2 === 0
                      ? "bg-gray-500 dark:bg-gray-800 dark:text-gray-200"
                      : "bg-gray-600 dark:bg-gray-900 dark:text-gray-200"
                  }`}
                >
...
export default EntryTableEditModel;
