        ...
        <div className="flex items-center justify-between px-4 sm:px-6 py-4 bg-gray-50/30 dark:bg-[#0F172A]/30 border-t border-gray-100 dark:border-gray-800">
          ...
          <div className="flex gap-2">
            <button
              onClick={handlePrev}
              disabled={page === 1}
              className="px-3 sm:px-4 py-2 text-sm font-medium rounded-xl border border-gray-200 dark:border-gray-700 hover:bg-white dark:hover:bg-gray-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
            >
              Previous
            </button>
            <button
